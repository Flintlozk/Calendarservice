...
<?	
if($_GET["staID"] == "0"){
		$sql_show = "SELECT service.userid,user,SerID,Location, Namecus, Detail, Navser, saveDate,update_Time,notation,service.TelID,team.Teamname
...
?>
	<tr>
		...
		<td>
            ...
            <input class="indexinput" type="hidden" name="textChangestat" value="1" />
		</td>
	</tr>
        <tr>    
        <td align='right' >
    ...
    <tr>
      	...
      	<td>
        	<input class="indexinput" id="datepicker-th1" name="textDatejob" type="text" size="10" value=""/>
		</td>
    </tr>
    <tr>
		<td align='right' >เวลาที่ขอเข้างาน: </td>
		<td>
        	<input class="indexinput" type="text" size="10" value="" disabled />
        </td>
	</tr>
	<tr>
		<td></td>
		<td><select class="indexinput"  name="textTimejob" value="" >
     	...
     	<tr>
      	<td align='right' >ทีมช่าง: </td>
      	<td>
        	<input class="indexinput" type="text"  value="" disabled/>
        </td>
	<tr>
      	<td></td>
          <td>
          <select class="indexinput" name="textTeamname" id="select" >
           <option value="" >--เปลียนทีม--</option>
                      <?
    ...
    <tr>
		<td>แก้ไขล่าสุด: </td>
		<td><input class="indexinput" type="text" name="" value="<?=$row_show["update_Time"]?>" disabled/></td>
    </tr>
    <tr>
...
?>							
    ...
    <tr>
      	...
      	<td>
        	<input class="indexinput" id="datepicker-th1" name="textDatejob" type="text" size="10" value="<?=$row_show["DATE_FORMAT(Datejob,'%d/%m/%Y')"];?>"  required />
		</td>
    </tr>
    <tr>
    <?
	...
	?>
		...
		<td>
        	<input class="indexinput" type="text" size="10" value="<?=$newtime;?>"  disabled/>
        </td>
	</tr>
	<tr>
		<td></td>
		<td><select class="indexinput"  name="textTimejob" value="" <? echo $disabled?> required >
    ...
    <tr>
		<td align='right' >หมายเหตุ: </td>
		<td><input class="indexinput" type="text" name="textNotation" value="<?=$row_show["notation"]?>"/></td>
        <td ><font color="red">*</font></td> 
    </tr>    
    <tr>
        <td valign="top" align='right' >รายละเอียด: </td>
        <td>
        	<textarea class="indexinput" name="textDetail" type="text" cols="100%" rows="28" required><?=$row_show["Detail"];?></textarea>
		</td>
        <td valign="top"><font color="red">*</font></td> 
    </tr>
    <tr>
